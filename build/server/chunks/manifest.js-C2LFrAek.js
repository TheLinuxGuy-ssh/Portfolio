...
return {
	...
	_: {
		...
		nodes: [
			...
			__memo(() => import('./nodes/6.js-RAMruqW1.js'))
		],
		remotes: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/jelly/_server.js-COCyMdaQ.js'))
			},
			{
				id: "/api/wakatime",
...
//# sourceMappingURL=manifest.js-C2LFrAek.js.map
