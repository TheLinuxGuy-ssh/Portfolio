	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/jelly/_server.js'))
			},
			{
				id: "/api/wakatime",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/wakatime/_server.js'))
			},
			{
				id: "/duskmeter",
				pattern: /^\/duskmeter\/?$/,
